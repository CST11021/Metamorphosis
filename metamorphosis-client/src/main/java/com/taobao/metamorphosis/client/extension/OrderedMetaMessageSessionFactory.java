...
import com.taobao.metamorphosis.client.extension.producer.*;
...
public class OrderedMetaMessageSessionFactory extends MetaMessageSessionFactory implements OrderedMessageSessionFactory {
     ...
     * 创建消息生产者
     *
     * @param partitionSelector 传入OrderedMessagePartitionSelector的继承类可支持消息散列到固定分区、可靠发送和顺序特性
     */
    @Override
