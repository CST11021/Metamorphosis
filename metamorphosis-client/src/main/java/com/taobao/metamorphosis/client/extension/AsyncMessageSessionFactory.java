...
public interface AsyncMessageSessionFactory extends MessageSessionFactory {
     ...
     *
     * @param partitionSelector 分区选择器
     * @param slidingWindowSize 控制发送流量的滑动窗口大小,4k数据占窗口的一个单位,参考值:窗口大小为20000比较合适. 小于0则用默认值20000.
     *                          窗口开得太大可能导致OOM风险
     * @return
     */
     ...
     * @return
     */
    public AsyncMessageProducer createAsyncProducer(final PartitionSelector partitionSelector, IgnoreMessageProcessor processor);
}